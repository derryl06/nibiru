          ...
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              ...
              <p className="font-medium text-secondary mb-10 leading-relaxed">
                Website Portofolio UI/UX Desain
              </p>
              <a
                href="#"
              ...
              <div className="relative mt-10 lg:mt-9 lg:right-0">
                ...
                <span className="absolute bottom-0 -z-10 left-1/2 -translate-x-1/2 md:scale-125">
                  ...
                  >
                    <path
                      fill="#06b6d4"
                      d="M45.6,-63.5C54.4,-56.4,53.6,-36.8,54,-21C54.5,-5.2,56.2,6.8,57,22.9C57.8,39,57.8,59.2,48.1,62.5C38.5,65.8,19.2,52.1,3.4,47.4C-12.5,42.7,-24.9,47.1,-38.4,45.1C-52,43.1,-66.6,34.7,-73.1,22C-79.6,9.4,-77.9,-7.7,-70.9,-21.1C-63.8,-34.5,-51.5,-44.2,-38.8,-50.1C-26.2,-56,-13.1,-57.9,2.7,-61.6C18.4,-65.2,36.8,-70.6,45.6,-63.5Z"
          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-10 lg:w-1/2">
              ...
              <h2 className="font-bold text-dark text-3xl mb-5 max-w-md lg:text-3xl">
                Miliki Desain website ekslusifmu
              </h2>
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <div className="flex items-center">
                {/* Youtube */}
                <a
                  href="https://youtube.com/derrylyouri"
                  target="_blank"
                ...
                {/* Instagram */}
                <a
                  href="https://instagram.com/derryours_"
                  target="_blank"
                  className="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-300 border-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                  <svg
                ...
                {/* Facebook */}
                <a
                  href="https://facebook.com/derryl.youri1"
                  target="_blank"
                  className="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-300 border-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                  <svg
                ...
                {/* Github */}
                <a
                  href="https://github.com/derryl06"
                  target="_blank"
                  className="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-300 border-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                  <svg
...
export async function getServerSideProps() {
  const dataResponse = await fetch("https://backder.herokuapp.com/");
